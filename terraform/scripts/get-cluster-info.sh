...
#
# This is a just slighty modified version of:
# https://github.com/hashicorp/terraform-aws-consul/blob/master/examples/consul-examples-helper/consul-examples-helper.sh
#

set -e

readonly SCRIPT_NAME="$(basename "$0")"
readonly IP_ONLY_PARAM="$1"
